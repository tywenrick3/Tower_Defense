...
atk_reload = 140	// time between attacks

shot_num_max = 1	// number of shots before reload

shot_cooldown = 7	// time between shots (if more than one)
...
crit_chance = 15		// the % chance to critically hit

shot_splash = false	// if the bullet does damage in an area

shot_dmg_min = 15	// minimum damage of bullet
shot_dmg_max = 35	// maximum damage of bullet
shot_crit_mult = 1.5	// number damage is multiplied by on crit

shot_dmg_bonus = 2		// extra dmg per 10% hp missing
